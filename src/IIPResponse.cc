...
#else
static char _IIPImage_h[] = "University of Edinburgh $Id: c99d15d314c701e6d4e93e15be115931fdfede65 $";
#endif
/*!
* \file         IPResponse.cc
* \author       Ruven Pillay, Zsolt Husz, Bill Hill
* \date         June 2008
* \version      $Id: c99d15d314c701e6d4e93e15be115931fdfede65 $
* \par
* Address:
...
void IIPResponse::addResponse(const char* g,
                              double a, double b, double c, double d )
{
  char tmp[128];
  snprintf(tmp, 128, "%s:%g %g %g %g", g, a, b, c, d);
  responseBody.append(tmp);
  responseBody.append(eof);
}
